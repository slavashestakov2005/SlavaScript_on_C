...
void Draw::initFunctions(){
    ...
    MFUNC_QUATERNARY(rect)
    MFUNC_QUATERNARY(frect)
    MFUNC_TERNARY(circle)
    MFUNC_TERNARY(fcircle)
    MFUNC_WITHOUT(repaint)
    MFUNC_WITHOUT(clear)
    MFUNC_INFO(framelimit, ArgumentsInfo(0, 1))
    MFUNC_WITHOUT(keypressed)
    MFUNC_WITHOUT(mousehover)
    MFUNC_WITHOUT(close)
}
